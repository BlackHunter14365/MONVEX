  ...
  return (
    <div className="space-y-2.5 my-3">
      <div className="flex items-center gap-1.5">
        ...
        <span className="text-[10.5px] font-bold text-[#898390] uppercase tracking-wider">
        ...
        >
          <div className="flex items-start justify-between gap-2">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                <span className="text-xs font-bold text-[#191522]">{rec.title}</span>
                {rec.impact && (
          ...
          {rec.actionPrompt && (
            <button
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#2A1F3D] hover:bg-[#3B2D54] text-white text-[11px] font-bold transition-all shadow-xs"
            >

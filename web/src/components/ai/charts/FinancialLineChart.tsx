...
export const FinancialLineChart: React.FC<Props> = ({ config }) => {
      ...
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 8, right: 12, left: -16, bottom: 4 }}>
          ...
          <XAxis
            ...
            tick={{ fill: '#858D9A', fontSize: 11, fontWeight: 500 }}
          />
          <YAxis
            tickLine={false}
            axisLine={false}
          ...
          {series.map((s, idx) => (
            <Line
              ...
              strokeWidth={2.5}
              dot={{ r: 3, fill: s.color || defaultColors[idx % defaultColors.length], strokeWidth: 1 }}
              activeDot={{ r: 5 }}
            />
          ))}
        </LineChart>

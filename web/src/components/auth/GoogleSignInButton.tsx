...
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({
  ...
  const renderGoogleButton = useCallback(() => {
    ...
    try {
      ...
      const targetWidth = Math.min(400, Math.max(240, Math.floor(availableWidth)));
  ...
  return (
    <div className={cn('relative w-full flex flex-col items-center justify-center min-h-[46px]', className)}>
      ...
      {gisState === 'LOADING' && (
        <div
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-[#E4E2DC] bg-white text-[#625D69] text-sm font-medium shadow-2xs min-h-[44px]"
        >
      ...
      {gisState === 'READY' && isLoading && (
        <div
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-[#E4E2DC] bg-[#FBFBFA] text-[#191522] text-sm font-medium shadow-2xs min-h-[44px]"
        >
      ...
      {gisState === 'READY' && disabled && !isLoading && (
        <div
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-[#E4E2DC] bg-[#F6F5F1] opacity-50 text-[#898390] text-sm font-medium shadow-2xs min-h-[44px] cursor-not-allowed"
        >
      ...
      {/* Error State Banner */}
      {gisState === 'ERROR' && (
        <div className="w-full flex items-center justify-between p-3 rounded-lg bg-[#FFF1F2] border border-[#FECDD3] text-[#E11D48] text-xs">

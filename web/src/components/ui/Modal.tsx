...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" role="dialog" aria-modal="true">
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-[#172033]/45 backdrop-blur-xs transition-opacity animate-in fade-in duration-150"
        onClick={onClose}
      />
      ...
      <div
        className={cn(
          'relative w-full max-h-[90vh] flex flex-col rounded-2xl bg-white border border-[#E4E2DC] p-6 shadow-2xl z-10 animate-in fade-in zoom-in-95 duration-150 text-[#172033] overflow-hidden',
